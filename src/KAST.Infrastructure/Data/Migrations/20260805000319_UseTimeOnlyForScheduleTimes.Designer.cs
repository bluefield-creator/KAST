...
namespace KAST.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260805000319_UseTimeOnlyForScheduleTimes")]
    partial class UseTimeOnlyForScheduleTimes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KAST.Core.Models.ServerInstance", b =>
                {
                    ...
                    b.Property<TimeOnly?>("AutoStartTime")
                        .HasColumnType("TEXT");

                    b.Property<TimeOnly?>("AutoStopTime")
                        .HasColumnType("TEXT");
