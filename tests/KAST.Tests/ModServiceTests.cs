...
public class ModServiceTests : IDisposable
{
    ...
    public async Task DownloadMod_SetsStatusToDownloading_ThenInstalled()
    {
        ...
        _steamService.DownloadWorkshopItemAsync(555, Arg.Any<string>(), Arg.Any<IProgress<double>>(), Arg.Any<IProgress<DownloadFileProgress>>(), Arg.Any<IProgress<string>>(), Arg.Any<int>(), Arg.Any<CancellationToken>())
    ...
    public async Task DownloadMod_BroadcastsStatusEvents()
    {
        ...
        _steamService.DownloadWorkshopItemAsync(777, Arg.Any<string>(), Arg.Any<IProgress<double>>(), Arg.Any<IProgress<DownloadFileProgress>>(), Arg.Any<IProgress<string>>(), Arg.Any<int>(), Arg.Any<CancellationToken>())
            .Returns(Task.FromResult(0UL));
    ...
    public async Task DownloadMod_SteamFails_SetsErrorStatus()
    {
        ...
        _steamService.DownloadWorkshopItemAsync(888, Arg.Any<string>(), Arg.Any<IProgress<double>>(), Arg.Any<IProgress<DownloadFileProgress>>(), Arg.Any<IProgress<string>>(), Arg.Any<int>(), Arg.Any<CancellationToken>())
